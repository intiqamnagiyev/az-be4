...
public class Human {
    ...
    public String print() {
            /* System.out.println("Human{" +
                ...
                "}");*/
        return String.format("Human{ name='%s', surname='%s', birthdate='%d', iq='%d', family='%s', schedule='%s'}",
                this.name, this.surname, this.birthDate, this.iq, this.family, Arrays.toString(schedule));
    }
